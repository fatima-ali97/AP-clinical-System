...
namespace AP_clinical_system.Controllers
{
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        [Route("api/{entityName}/set-inactive")]
